...
## Structure
    ...
    tests/kernel/
      test_encode_smoke.fard    -- basic run check
      test_encode_vectors.fard  -- exact byte vector tests (primitives)
      test_encode_types.fard    -- full type coverage
    main.fard       -- demo
...
- Content-addressable: SHA-256(encode(v)) is a stable CID for any value
